...
public static class IConfigurationExtensions
{
    ...
    /// if the configuration key is found with a non-null and non-empty value; otherwise,
    /// the default value for the type of the value parameter.
    /// This parameter is passed uninitialized.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <see cref="IConfiguration"/> contains a non-null and non-empty
    /// value for the <c>PERIODIC_TASK_NAME</c> configuration key; otherwise <see langword="false"/>.
    /// </returns>
